...
CREATE TABLE secretary_assignments (
  ...
  can_delete_clients BOOLEAN DEFAULT true,
  ...
  can_reactivate_services BOOLEAN DEFAULT true,
  can_manage_billing BOOLEAN DEFAULT true,
  can_create_invoices BOOLEAN DEFAULT true,
  can_edit_invoices BOOLEAN DEFAULT true,
  can_delete_invoices BOOLEAN DEFAULT true,
  can_send_invoices BOOLEAN DEFAULT true,
  can_manage_reports BOOLEAN DEFAULT true,
  can_view_reports_dashboard BOOLEAN DEFAULT true,
  can_export_reports BOOLEAN DEFAULT true,
  can_manage_hotspot BOOLEAN DEFAULT true,
  can_create_hotspot_users BOOLEAN DEFAULT true,
  can_edit_hotspot_users BOOLEAN DEFAULT true,
  can_delete_hotspot_users BOOLEAN DEFAULT true,
  can_manage_vouchers BOOLEAN DEFAULT true,
  can_sell_vouchers BOOLEAN DEFAULT true,
  can_print_vouchers BOOLEAN DEFAULT true,
  can_view_hotspot_accounting BOOLEAN DEFAULT true,
  can_view_hotspot_reports BOOLEAN DEFAULT true,
  can_manage_address_list BOOLEAN DEFAULT true,
  can_create_address_list BOOLEAN DEFAULT true,
  can_delete_address_list BOOLEAN DEFAULT true,
  can_manage_backup BOOLEAN DEFAULT true,
  can_create_backup BOOLEAN DEFAULT true,
  can_restore_backup BOOLEAN DEFAULT true,
  can_manage_vps_services BOOLEAN DEFAULT true,
  can_view_vps BOOLEAN DEFAULT true,
  can_manage_vps_docker BOOLEAN DEFAULT true,
  can_manage_radius BOOLEAN DEFAULT true,
  can_manage_radius_users BOOLEAN DEFAULT true,
  can_view_radius_stats BOOLEAN DEFAULT true,
  can_manage_onu BOOLEAN DEFAULT true,
  can_configure_onu_wifi BOOLEAN DEFAULT true,
  can_reboot_onu BOOLEAN DEFAULT true,
  can_manage_settings BOOLEAN DEFAULT true,
  can_manage_diagnostics BOOLEAN DEFAULT true,
  created_at TIMESTAMPTZ DEFAULT now(),
