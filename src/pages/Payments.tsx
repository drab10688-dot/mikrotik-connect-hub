...
import { Receipt, BarChart3, ExternalLink, Settings2, CreditCard } from "lucide-react";
    ...
    <div className="flex min-h-screen bg-background">
      ...
      <div className="p-4 md:p-8 md:ml-64 w-full">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6 md:mb-8">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-foreground">Facturación y Pagos</h1>
            <p className="text-muted-foreground">
              Gestiona pagos, facturación, reportes y configuración
            </p>
          </div>
